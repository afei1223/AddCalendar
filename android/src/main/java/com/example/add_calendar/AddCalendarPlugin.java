package com.example.add_calendar;
...
/** AddCalendarPlugin */
public class AddCalendarPlugin implements FlutterPlugin, MethodCallHandler, ActivityAware {
  ...
  public void onAttachedToEngine(@NonNull FlutterPluginBinding flutterPluginBinding) {
    mMethodChannel = new MethodChannel(flutterPluginBinding.getBinaryMessenger(), "add_calendar");
    mApplication = (Application) flutterPluginBinding.getApplicationContext();
    mMethodChannel.setMethodCallHandler(this);
  }


  public AddCalendarPlugin initPlugin(MethodChannel methodChannel, Registrar registrar) {
  ...
  public static void registerWith(Registrar registrar) {
    ...
    channel.setMethodCallHandler(new AddCalendarPlugin().initPlugin(channel,registrar));
  }
